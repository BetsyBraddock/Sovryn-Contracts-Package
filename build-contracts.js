...
const addresses = process.env.chain === "testnet" ? contractsTestnet : contractsMainnet
const web3 = new Web3(process.env.chain === "testnet" ? "https://testnet2.sovryn.app/rpc" : "https://mainnet2.sovryn.app/rpc");
