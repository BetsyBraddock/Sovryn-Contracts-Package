const abi: Object[] = [
  ...
  {
    constant: false,
    inputs: [{ name: '_dynamicFeeFactor', type: 'uint256' }],
    name: 'setDynamicFeeFactor',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  { payable: true, stateMutability: 'payable', type: 'fallback' },
  {
    anonymous: false,
    inputs: [
      { indexed: false, name: '_prevFactor', type: 'uint256' },
      { indexed: false, name: '_newFactor', type: 'uint256' },
    ],
    name: 'DynamicFeeFactorUpdate',
    type: 'event',
  },
  {
    anonymous: false,
